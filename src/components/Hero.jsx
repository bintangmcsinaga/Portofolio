        ...
        <section id="home" className="min-h-screen flex flex-col items-center justify-center pt-16 relative overflow-hidden">
            ...
            <div className="text-center z-10 w-full px-4">
                ...
                >
                    <a
                        href="#projects"
                        className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full font-medium text-white hover:shadow-lg hover:shadow-cyan-500/25 transition-all duration-300 transform hover:-translate-y-1"
                    >
                        View Work
                    </a>
                    <a
                ...
                <motion.div
                    ...
                    className="mt-16 max-w-lg mx-auto w-full"
                >
                    <div className="rounded-2xl border border-gray-800 bg-gray-900/70 p-3 shadow-xl backdrop-blur-sm transition-transform hover:scale-[1.02] duration-300">
                        <img
